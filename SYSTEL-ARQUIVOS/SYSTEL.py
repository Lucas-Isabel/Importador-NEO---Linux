    ...
    while(True):
        ...
        if(os.path.isfile(arquivo)):
            ...
            if(os.path.isfile(arquivo_portas)):
                time.sleep(1)
                data_atualizacao_timestamp_portas = os.path.getmtime(arquivo_portas)
                data_atualizacao_portas = str(datetime.datetime.fromtimestamp(data_atualizacao_timestamp_portas))
